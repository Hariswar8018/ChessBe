              ...
              child: Padding(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: 30,),
                      Center(child: Text("ChessBe", style: TextStyle( fontFamily: "font1", fontSize: 30, color: Color(0xffff79ac))),),
                      SizedBox(height: 20,),
                      Image.asset("assets/5e45c3f6445fba750c3b4776c7a298fb.gif"),
                      SizedBox(height: 30,),
                      TextFormField(
                      ...
                      Row(
                        ...
                        children: [
                          TextButton(onPressed: () {
                            Navigator.push(
                                context, PageTransition(
                                child: Country(justname: false,), type: PageTransitionType.rightToLeft, duration: Duration(milliseconds: 800)
                            ));
